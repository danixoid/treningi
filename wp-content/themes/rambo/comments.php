...
<?php  
 $fields=array(
    'author' => '<lable>Имя</lable><span>*<span><br/>
	...
	'website'=>	'<lable>Сайт</lable><br/><input class="span9 leave_comment_field" name="email" id="email" value=""   type="text" ><br/>',
	);
...
add_filter('comment_form_default_fields','my_fields');
	...
	'comment_field'        => '<label>Комментарий<span>*</span></label>
