...
<div class="container">
	...
	<div class="row-fluid">
		...
		<div class="span8 Blog_main">
			...
			<a href="<?php the_permalink(); ?>"><i class="fa fa-comments icon-spacing"></i><?php comments_popup_link( 'Комментариев нет', '1 комментарий', '% комментарии', 'comments-link', 'Комментарии отключены' ); ?></a>
