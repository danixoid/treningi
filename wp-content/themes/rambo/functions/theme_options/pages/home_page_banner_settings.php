<div class="block ui-tabs-panel deactive" id="option-ui-id-2" >
	<h2>Главная - Настройки баннера</h2><hr>	
	...
	<form method="post" id="rambo_theme_options_2">
		...
		<div class="section">
			<h3><?php _e('Баннер на главной','rambo'); ?>  </h3>
			<input type="checkbox" <?php if($current_options['home_banner_enabled']=='on') echo "checked='checked'"; ?> id="home_banner_enabled" name="home_banner_enabled" > <span class="explain"><?php _e('Включить баннер для главной с шаблоном Business Home Page','rambo'); ?></span>
		</div>					
		<div class="section">
			<h3><?php _e('Картинка баннера','rambo'); ?>
				<span class="icons help"><span class="tooltip"><?php  _e('Картинка баннера должна быть 1600 X 400 px','rambo');?></span></span>
			</h3>
		...
		<div class="section">
			...
			<span class="icons help"><span class="tooltip">введите заголовок для баннера/span></span>
		</div>
		<div class="section">
			<h3><?php _e('Описание баннера','rambo'); ?></h3>
			...
			<div class="">Введите описание, желательно до 150 симв.<br></div>
		</div>	
		
		<div id="button_section">
			<input type="hidden" value="1" id="rambo_settings_save_2" name="rambo_settings_save_2" />
			<input class="reset-button btn" type="button" name="reset" value="По умолчанию" onclick="rambo_option_data_reset('2');">
			<input class="btn btn-primary" type="button" value="Сохранить настройки" onclick="rambo_option_data_save('2')" >
			<!--  alert massage when data saved and reset -->
			<div class="rambo_settings_save" id="rambo_settings_save_2_success" >Настройки сохранены</div>
			<div class="rambo_settings_save" id="rambo_settings_save_2_reset" >Настройки восстановленны по умолчанию</div>
		</div>
	</form>
</div>
