...
<?php $current_options = get_option('rambo_theme_options');
	...
	<h2><?php _e('Основные настройки','rambo');?></h2><hr>	
	<form method="post" id="rambo_theme_options_1">
		...
		<div class="section">
			<h3><?php _e('Как на главной задаст страницу с шаблоном Business Home Page?','rambo'); ?>  </h3>
			<span class="explain" id="explain"><b>Создаете страницу с шаблоном Business Home Page, потом >> Параметры >> Чтение >> На главной странице отображать >> указываем нашу страницу.</b></span>
		</div>			
		<div class="section">
			<h3><?php _e('Логотип','rambo'); ?>
				<span class="icons help"><span class="tooltip"><?php  _e('Логотип должен быть 150 X 50 px','rambo');?></span></span>
			</h3>
		...
		<div class="section">
			<h3><?php _e('Логотип высота','rambo'); ?>
				<span class="icons help"><span class="tooltip"><?php  _e('Высота логотипа должена быть меньше 80px','rambo');?></span></span>
			</h3>
			<input class="webriti_inpute"  type="text" name="height" id="height" value="<?php echo $current_options['height']; ?>" >						
		</div>
		<div class="section">
			<h3><?php _e('Логотип Ширина','rambo'); ?>
				<span class="icons help"><span class="tooltip"><?php  _e('Шарина логотипа должена быть меньше 200 px','rambo');?></span></span>
			</h3>
			<input  class="webriti_inpute" type="text" name="width" id="width"  value="<?php echo $current_options['width']; ?>" >			
		</div>
		<div class="section">
			<h3><?php _e('Текстовый логотип','rambo'); ?></h3>
			<input type="checkbox" <?php if($current_options['rambo_texttitle']=='on') echo "checked='checked'"; ?> id="rambo_texttitle" name="rambo_texttitle" > <span class="explain">Включить текстовый логотип для сайта</span>
		</div>
		<div class="section">
			<h3><?php _e('Иконка сайта - Favicon','rambo'); ?>
				<span class="icons help"><span class="tooltip"><?php  _e('Favicon должно быть 25 X 25 px','rambo');?></span></span>
			</h3>
		...
		<div class="section">
			...
			<div class="explain"><?php _e('Вставьте свой CSS, чтобы изменить тему без ручного редактирования.','rambo'); ?><br></div>
		</div>		
		<div id="button_section">
			<input type="hidden" value="1" id="rambo_settings_save_1" name="rambo_settings_save_1" />
			<input class="reset-button btn" type="button" name="reset" value="По умолчанию" onclick="rambo_option_data_reset('1');">
			<input class="btn btn-primary" type="button" value="Сохранить настройки" onclick="rambo_option_data_save('1')" >
			<!--  alert massage when data saved and reset -->
			<div class="rambo_settings_save" id="rambo_settings_save_1_success" ><?php _e('Настройки сохранены','rambo');?></div>
			<div class="rambo_settings_save" id="rambo_settings_save_1_reset" ><?php _e('Настройки восстановленны по умолчанию','rambo');?></div>
		</div>
	</form>
</div>